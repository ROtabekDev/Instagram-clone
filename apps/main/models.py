...
class Notification(BaseModel):
    ...
    sender_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="notification_from_user", verbose_name='Yuboruvchi user')
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="notification_to_user", verbose_name='Qabul qiluvchi user')
    ...
    notification_type = models.CharField('Bildirishnoma turi', choices=NOTIFICATION_TYPE, max_length=30, null=True, blank=True)
