...
class Notification(BaseModel):
    ...
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="notification_from_user", verbose_name='Qabul qiluvchi user')
    post_id = models.ForeignKey(Post, on_delete=models.CASCADE, related_name="notification_to_user", null=True, blank=True)
